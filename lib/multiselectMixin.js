...
function filterOptions(options, search, label, customLabel, customOptionInd) {
  return options.filter(function (option, ind) {
...
function filterGroups(search, label, values, groupLabel, customLabel, customOptionInd) {
  return function (groups) {
    return groups.map(function (group) {
      ...
      var groupOptions = filterOptions(group[values], search, label, customLabel, customOptionInd);
...
exports.default = {
  ...
  computed: {
    filteredOptions: function filteredOptions() {
      ...
      if (this.internalSearch) {
        options = this.groupValues ? this.filterAndFlat(options, normalizedSearch, this.label) : filterOptions(options, normalizedSearch, this.label, this.customLabel, this.customOptionInd);
      } else {
  ...
  methods: {
    ...
    filterAndFlat: function filterAndFlat(options, search, label) {
      return flow(filterGroups(search, label, this.groupValues, this.groupLabel, this.customLabel, this.customOptionInd), flattenOptions(this.groupValues, this.groupLabel))(options);
    },
    ...
    updateSearch: function updateSearch(query) {
      if (this.allowCustom) {
        ...
        if (query) {
          var customOption = this.allowCustom(query);
